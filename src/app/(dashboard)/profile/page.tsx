...
const learningStyles: {
...
}[] = [
  {
    ...
    label: "Visual",
    description:
      "You learn best through diagrams, charts, and seeing information laid out spatially.",
    icon: Eye,
    color: "text-blue-400",
  ...
  },
  {
    ...
    label: "Auditory",
    description:
      "You learn best by listening, discussing, and talking through concepts.",
    icon: Headphones,
  ...
  },
  {
    ...
    description:
      "You learn best through reading text and taking written notes.",
    icon: BookOpen,
  ...
  },
  {
    ...
    label: "Kinesthetic",
    description:
      "You learn best through practice, hands-on activities, and doing.",
    icon: Activity,
...
export default function ProfilePage() {
  ...
  // Initialise directly from user to avoid setState-in-effect lint error
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex">
      ...
      {/* ml matches sidebar width; on mobile sidebar is hidden so no offset needed */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-2 bg-white/5 border border-white/10 rounded-2xl p-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6">
              {learningStyles.map(
                ({ value, label, description, icon: Icon, color, bg }) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        <div
                          className={`w-9 h-9 rounded-xl flex items-center justify-center ${selected ? bg : "bg-white/5"}`}
                        >
                          <Icon
                            size={17}
                      ...
                      <p
                        className={`font-semibold text-sm mb-1 ${selected ? "text-white" : "text-slate-300"}`}
                      >
                        {label}
                      </p>
            ...
            <button
              onClick={handleSave}
              disabled={
                !selectedStyle || saving || selectedStyle === user.learningStyle
              }
            ...
            {user.learningStyle && selectedStyle === user.learningStyle && (
              <p className="text-slate-600 text-xs mt-3">
                ...
                . Select a different one to update.
              </p>
            )}
          </div>
        </div>
